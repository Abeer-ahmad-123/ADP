...
export const ADMIN_STATUS_MESSAGES: Record<string, string> = {
  ...
  "hero-image-error": "Hero settings could not be updated.",
  "hero-image-invalid": "Please add a hero flag image or caption.",
  "hero-image-updated": "Hero settings updated successfully.",
  ...
  "membership-card-image-error": "Membership card image could not be updated.",
  "membership-card-image-invalid": "Please choose a membership card image.",
  "membership-card-image-updated": "Membership card image updated successfully.",
