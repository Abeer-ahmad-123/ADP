...
export const ADMIN_STATUS_MESSAGES: Record<string, string> = {
  ...
  "hero-image-error": "Hero flag image could not be updated.",
  "hero-image-invalid": "Please choose a hero flag image file.",
  "hero-image-updated": "Hero flag image updated successfully.",
